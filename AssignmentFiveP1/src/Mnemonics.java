...
* This Program Uses Recursion To Generate Phone Number Mnemonics
* Part #1 Of Assignment 5
*
****************************************************************************/
...
"DEF","GHI","JKL","MNO","PQRS","TUV","WXYZ"};
    ...
    public static void main(String args[])
    {
        ...
        try 
        {
    	    ...
    	    NUMBER_OF_DIGITS = phoneNumber.length(); // length the mnemonics solution must have
    	    solveMnemonic(phoneNumber);  // goes to procedure which then leads to the recursive function
     	} 	
